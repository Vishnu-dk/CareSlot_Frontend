...
export default function CarePlanDetailModal({
  isOpen,
  onClose,
  planId,
  showError,
          ...
          <Flex justify="space-between" align="center">
            <Box>
              ...
              <Text
                ...
                mt={1}
              >
                Dr. {plan.clinicianName} ·{" "}
                {fmtDate(plan.createdAt.slice(0, 10))}
              </Text>
            </Box>
            ...
            >
              <Box position="relative" flexShrink={0}>
                ...
                >
                  ...
                  <Text fontSize={{ base: "8px", md: "10px" }} color="#5D4037">
                    Done
                  </Text>
                </Flex>
              </Box>
              ...
              <Box flex={1} textAlign={{ base: "center", md: "left" }}>
                ...
                <Text
                  ...
                  fontStyle="italic"
                >
                  Note: Completed tasks cannot be undone. Expired tasks cannot
                  be started.
                </Text>
              </Box>
            </Flex>
                  ...
                  return (
                    ...
                    >
                      <Checkbox
                        ...
                        isDisabled={isDone || updating}
                        colorScheme="green"
                        size="lg"
                        sx={{
                          ".chakra-checkbox__control": { w: "20px", h: "20px" },
                        }}
                      />
