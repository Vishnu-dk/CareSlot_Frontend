...
import {
  Box, Button, Drawer, DrawerBody, DrawerContent, DrawerFooter, DrawerHeader,
  DrawerOverlay, Flex, FormControl, FormLabel, Heading, Input, Text, VStack, useDisclosure,
...
export default function AvailabilityPage() {
  ...
  const { data: availability = [], isLoading } = useGetMyWeeklyAvailabilityQuery();
  ...
  return (
    <Box  mx="auto" py={4}>
      ...
      <Box bg="beige" borderRadius="20px" p={6}  boxShadow={CARD_SHADOW}>
        <Text fontSize={{base: "14px", md: "18px"}} fontWeight={700} color="espresso" mb={4}>Weekly Schedule</Text>
        ...
        <VStack spacing={2} align="stretch" maxW="900px" mx="auto">
          {DAYS.map((day, idx) => {
            ...
            return (
              ...
              >
                <Text w="40px" fontWeight={700} fontSize={{base: "12px", md: "14px"}} color="espresso">{day}</Text>
                
                <Box flex={1}>
                  {hasHours ? (
                    <Text fontSize={{base: "11px", md: "13.5px"}} color="#5D4037">
                      {data.startTime.slice(0, 5)} – {data.endTime.slice(0, 5)}
                    </Text>
                  ) : (
                    <Text fontSize={{base: "11px", md: "13.5px"}} color="#D7CCC8" fontStyle="italic">Day off</Text>
                  )}
                </Box>
                ...
                <Box
                  ...
                  fontWeight={600}
                  bg={hasHours ? "rgba(160,120,85,0.12)" : "rgba(107,114,128,0.08)"}
      ...
      <Drawer isOpen={isOpen} placement="right" onClose={onClose} size="md">
        ...
        <DrawerContent bg="cream" boxShadow="-8px 0 40px rgba(62,39,35,0.15)">
          <DrawerHeader borderBottomWidth="1px" borderColor="taupe">
            <Text fontSize={{base: "9px", md: "12.5px"}} fontWeight={600} color="#5D4037" textTransform="uppercase" letterSpacing="0.08em" mb={1}>
              Edit Hours
            </Text>
            <Heading fontSize={{base: "18px", md: "24px"}} fontWeight={800} color="espresso">
          ...
          <DrawerBody>
            <VStack spacing={6} align="stretch" pt={4}>
              <FormControl>
                <FormLabel fontSize={{base: "10px", md: "12px"}} fontWeight={600} color="#5D4037">Start Time</FormLabel>
                <Input
                  type="time"
                  value={startTime}
              ...
              <FormControl>
                <FormLabel fontSize={{base: "10px", md: "12px"}} fontWeight={600} color="#5D4037">End Time</FormLabel>
                <Input
                  type="time"
                  value={endTime}
          ...
          <DrawerFooter borderTopWidth="1px" borderColor="taupe" flexDirection="column" gap={3} pt={6}>
            <Button w="full" variant="primary" borderRadius="full" onClick={handleSave} fontSize={{base: "10px", md: "14px"}}>
              Save Hours
            </Button>
            ...
            <Button w="full" fontSize={{base: "10px", md: "14px"}} variant="ghost" color="espresso" onClick={onClose}>
              Cancel
            </Button>
          </DrawerFooter>
        </DrawerContent>
